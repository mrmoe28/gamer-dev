    ...
    try {
      ...
      if (response.ok) {
        ...
        setProfileData({
          ...
          preferredRoles: data.preferredRoles ? JSON.parse(data.preferredRoles) : [],
    ...
    if (file) {
      ...
      reader.onload = async (e) => {
        ...
        try {
          ...
          if (response.ok) {
            setSaveMessage('Profile image saved successfully!');
          ...
          setSaveMessage('Error saving profile image. Please try again.');
        } finally {
          setIsLoading(false);
        }
      };
